...
def select_difficulty():
    ...
    if choice == "1":
        ...
        print("Invalid choice. Defaulting to Medium (25x25).")
        return 25, 25
    ...
    for row in grid:
        for cell in row:
            ...
            if cell.right:
                ...
                start_pos = (cell.x + 1) * cell_width - \
                    line_width, cell.y * cell_height
...
def solve_maze(screen, grid, cell, solution_order=None):
    ...
    unvisited_neighbors = [
        neighbor for neighbor in cell.open_neighbors if not neighbor.visited]
